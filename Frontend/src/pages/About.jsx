...
const About = () => {
  ...
  return (
    <div className="relative overflow-x-hidden bg-[#fdf6ec] text-[#2a1a0a]">
      ...
      {/* STATS SECTION */}
      <section className="relative mx-auto flex max-w-6xl flex-wrap justify-center gap-6 px-4 py-16 sm:px-6 sm:py-20">
        {[
          { num: '1000+', labelKey: 'pujasCompleted' },
          { num: '500+', labelKey: 'happyDevoteesLabel' },
          { num: '150+', labelKey: 'verifiedPandits' },
        ].map((item, i) => (
          <motion.div key={i} className="w-full max-w-[320px] rounded-2xl border border-[rgba(212,162,76,0.2)] bg-white/70 px-6 py-6 text-center shadow-md backdrop-blur-md transition hover:-translate-y-2 hover:border-[rgba(212,162,76,0.4)] hover:bg-white/90 hover:shadow-[0_0_20px_rgba(212,162,76,0.2)] sm:min-w-[200px] sm:px-8" initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.2 }}>
      ...
      <section className="mx-auto flex max-w-6xl flex-wrap justify-center gap-6 px-4 py-16 sm:px-6 sm:py-20">
        <motion.div className="min-w-0 w-full max-w-[520px] flex-1 rounded-2xl border border-[rgba(212,162,76,0.2)] bg-white/70 p-6 text-center shadow-md backdrop-blur-md transition hover:scale-[1.02] hover:border-[rgba(212,162,76,0.4)] hover:bg-white/90 hover:shadow-lg sm:p-8" whileHover={{ scale: 1.05 }}>
      ...
      {/* CTA */}
      <section className="relative overflow-hidden bg-[linear-gradient(135deg,#836348_0%,#471f05_100%)] px-4 py-16 text-center sm:px-6 sm:py-24">
